...
class PostArticleFormViewModelImpl: NSObject, PostArticleFormViewModel {
    ...
    init(basicViewModel: BasicViewModel = BasicViewModelImpl(), api: Provider<MultiTarget> = ProviderAPIWithRefreshToken<MultiTarget>(stubClosure: MoyaProvider.delayedStub(0.5))) {
