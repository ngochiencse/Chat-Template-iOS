...
class BaseViewController: UIViewController, BasicViewPresentableView {
    ...
    init(basicViewModel: BasicViewModel = BasicViewModelImpl(), nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
    ...
    func present(_ viewControllerToPresent: UIViewController,
        ...
        if withNavigationController == true {
            ...
            if viewControllerToPresent is BaseViewController {
                let nav: BaseNavigationController = BaseNavigationController(rootViewController: viewControllerToPresent)
